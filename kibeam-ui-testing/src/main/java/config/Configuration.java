...
public class Configuration {
    ...
    public static final String ACCESSIBILITY_FAIL_ON_CRITICAL = "accessibility.fail.on.critical";
    public static final String ACCESSIBILITY_RULES = "accessibility.rules";
    ...
    public boolean isAccessibilityEnabled() {
        return getBoolean(ACCESSIBILITY_ENABLED, true);
    }

    /**
     * Check if tests should fail when critical accessibility violations are found.
     *
     * @return true if tests should fail on critical violations (default: false)
     */
    public boolean shouldFailOnCritical() {
        return getBoolean(ACCESSIBILITY_FAIL_ON_CRITICAL, false);
    }

    /**
     * Get accessibility rules to check (comma-separated).
     *
     * @return accessibility rules string, or empty string if not configured
     */
    public String getAccessibilityRules() {
        return getString(ACCESSIBILITY_RULES, "");
    }
