    ...
    public void onStart(ISuite suite) {
        ...
        if (initialized.compareAndSet(false, true)) {
            ...
            if (reportName != null && !reportName.isEmpty()) {
                ...
                // Use smart naming based on -Dtest and -Ddevice properties
                String generatedName = buildReportNameFromProperties(suiteName);
                ExtentReportManager.setReportName(generatedName);
            }

            if (reportTitle != null && !reportTitle.isEmpty()) {
                ExtentReportManager.setReportTitle(reportTitle);
            } else {
                // Use smart title based on -Dtest and -Ddevice properties
                String generatedTitle = buildReportTitleFromProperties(suiteName);
                ExtentReportManager.setReportTitle(generatedTitle);
            }
    ...
    public void onStart(ITestContext context) {
        ...
        if (initialized.compareAndSet(false, true)) {
            ...
            if (reportName != null && !reportName.isEmpty()) {
                ...
                String generatedName = buildReportName(context, suiteName);
                ExtentReportManager.setReportName(generatedName);
            }
            ...
            if (reportTitle != null && !reportTitle.isEmpty()) {
                ...
                String generatedTitle = buildReportTitle(context, suiteName);
                ExtentReportManager.setReportTitle(generatedTitle);
            }
